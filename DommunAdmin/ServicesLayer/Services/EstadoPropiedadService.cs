...
namespace DommunAdmin.ServicesLayer.Services
{
    public class EstadoPropiedadService : IEstadoPropiedadService
    {
        ...
        public async Task<ResultadoApi> DeleteEstadoPropiedad(int? Id)
        {
        ...
        public async Task<ResultadoApi> InsertEstadoPropiedad(EstadoPropiedadDto objeto)
        {
            ResultadoApi resultado = new ResultadoApi();
        ...
        public async Task<ResultadoApi> UpdateEstadoPropiedad(EstadoPropiedadDto objeto)
        {
            ResultadoApi resultado = new ResultadoApi();
        ...
        public async Task<List<SelectListItem>> GetSelectListItems()
        {
            ...
            List<EstadoPropiedadDto> elements = new List<EstadoPropiedadDto>();

            elements = await GetAllEstadoPropiedades();
